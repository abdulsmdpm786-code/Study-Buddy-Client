...
// 🚨 Accept onClose function from parent
function CourseModal({  onClose, data }) {
...
console.log("from modal...",data);
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
      {/* Remove id="form-modal" and hidden class dependencies */}
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-1 mb-3 flex items-center justify-center w-full h-36 rounded-xl border-2 border-dashed
