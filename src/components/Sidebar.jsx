  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 mx-4 mb-8 p-3.5 bg-white/70 rounded-xl shadow-sm border border-white/80">
        ...
        <button
          className="md:hidden bg-transparent text-slate-500 text-xl ml-auto"
      ...
      <nav className="flex flex-col gap-1.5 px-4">
        ...
        <Link
          to={"Course"}
          className="flex items-center px-5 py-3.5 gap-4 text-slate-500 font-semibold rounded-xl transition-all 
        ...
        <a
          ...
          href="#"
          className="flex items-center px-5 py-3.5 gap-4 bg-rose-700 text-white font-semibold rounded-xl transition-all
